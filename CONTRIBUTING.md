...
Thank you for contributing to AttestoMCP. Open an issue before a large change
so the intended behavior and compatibility constraints can be agreed first.
